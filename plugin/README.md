...
Opinionated skills and agents for **AI PMs, engineering managers, TPMs, and senior ICs leading without authority**. 30 skills + 13 agents, namespaced under `bettersense:` (e.g. `/bettersense:coaching-mode`, `/bettersense:wins-log`).
