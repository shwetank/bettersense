---
name: career-retro
description: Use for a periodic (quarterly / half / annual) career retrospective that reads the ENTIRE bettersense memory and produces a longitudinal self-assessment — where you were, where you are, the growth deltas since your last retro, and the honest gaps to work on next. Trigger phrases include "run my career retro", "where am I in my career", "annual self-assessment", "how have I grown this year", "half-year reflection on my trajectory", "it's review season, take stock of everything". Reads wins.md, all stakeholder reflections, self/reflections.md, pulses, team charters, and any ADRs you point to; writes a dated retro to self/retros/ so the NEXT retro can measure change. Distinct from wins-curate (which remixes wins.md into one audience-facing artifact like a promo packet or perf-review self-eval — hand the formal submission document to it) and self-reflect (a single in-the-moment reflection entry). This is the meta-synthesis across everything, and the one skill whose output compounds most over years.
---
